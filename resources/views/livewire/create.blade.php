<!-- Modal -->
<div wire:ignore.selt class="modal fade" id="addStudentModal" tabindex="-1" arialabelledby="exampleModalLabel" aria-hidden="true">
...
<input type="url" name="image" class="form-control" wire:model="image"/>
</div>
</form>
</div>
<div class="modal-footer">
<button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Close</button>
<button type="button" class="btn btn-outline-success" data-bs-dismiss="modal" wire:click.prevent="store()">Agregar Producto</button>
</div>
</div>
</div>
</div>
